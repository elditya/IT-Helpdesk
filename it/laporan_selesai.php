                    ...
                    <!-- ============================================================== -->
                            ...
                            <div class="col-xl-12 col-lg-15 col-md-6 col-sm-15 col-15">
                                ...
                                <h5 class="card-header">Form Add User</h5>
                                    <div class="card-body">
                                        <form action="config_laporan_selesai.php" method="post" enctype="multipart/form-data">
                                            <?php
                                            ...
                                            <label for="status" class="col-form-label">Status Kerusakan</label>
                                              <input id="status" type="text" class="form-control form-control-user" id="status_pengerjaan" name="status_pengerjaan" value="Selesai" readonly>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="waktu_selesai" class="col-form-label">Waktu Laporan Selesai</label>
                                                <input id="waktu_selesai" name="waktu_selesai" type="time" value="<?php echo $jkt;?>" class="form-control" readonly>
                                            </div>
