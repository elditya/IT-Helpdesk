                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-6" class="collapse submenu" style="">
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link" href="it_home.php"><i class="fas fa-clipboard-list"></i>Tiket Belum selesai</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                $query_mysql = mysqli_query($host, "SELECT * FROM kerusakan WHERE status_pengerjaan NOT LIKE 'selesai'");
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="laporan_selesai.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-outline-primary"  ><i class="fas fa-fw fa-check"></i>Selesai</a></td>
                                                        <td><a href="edit_laporan.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-outline-primary"  ><i class="fas fa-fw fa-check"></i>Menaggapi</a></td>
                                                    </tr>
