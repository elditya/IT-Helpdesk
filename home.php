                        ...
                        <li class="nav-divider">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-6" class="collapse submenu" style="">
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link" href="admin/tiket_selesai.php"><i class="fas fa-check"></i>Tiket Laporan Selesai</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="admin/user_control.php"><i class="fas fa-fw fa-user"></i>User Control</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <!-- ============================================================== -->
                            ...
                            <div class="col-xl-12 col-lg-15 col-md-6 col-sm-15 col-15">
                                <div class="card">
                                    <h5 class="card-header">Tiket yang belum dikerjakan</h5>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span class="badge-dot badge-secondary mr-1"></span><?php echo $data['jenis_kerusakan']; ?></td>
