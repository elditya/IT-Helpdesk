                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                $query_mysql = mysqli_query($host,"SELECT * from user where username = '$nama'");
                                $data1 = mysqli_fetch_array($query_mysql);
                                 ?>
                                <a type="button" class="btn btn-outline-primary btn-lg" href="buat_laporan.php?id=<?php echo $data1['id']; ?>"><i class="fas fa-fw fa-plus"></i>Buat Laporan</a>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <!-- ============================================================== -->
                            ...
                            <div class="col-xl-12 col-lg-15 col-md-6 col-sm-15 col-15">
                                <div class="card">
                                    <h5 class="card-header">Tiket HelpDesk <?php echo $_SESSION['username'] ?> </h5>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Waktu buat</th>
                                                ...
                                                $nama = $_SESSION['username'];
                                                $sql = mysqli_query($host,"SELECT * from kerusakan where nama ='$nama' AND status_pengerjaan not like 'selesai'");
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><img src="<?php echo '../assets/images/'.$data['foto_kerusakan'];?>" width="200px" height="150px"></td>
                                                    <td><a href="edit_laporan.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-outline-success"><i class="fas fa-fw fa-edit"></i> Edit</a></td>
                                                    </tr>
